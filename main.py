...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="http://t.me/StudyXashiahContact_bot")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/StudyXashish"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/StudyXashish")],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/StudyXashish")],
        ])
...
async def feature_button(client, callback_query):
  ...
  keyboard = InlineKeyboardMarkup([
      ...
      [InlineKeyboardButton("💧 Watermark", callback_data="watermark_command"), InlineKeyboardButton("🔄 Reset", callback_data="resat_command")],
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.ibb.co/chtBPbJ8/x.jpg",
      caption=caption
    ),
    reply_markup=keyboard
  )
...
async def pin_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://i.ibb.co/jkwpX4Tp/x.jpg",
      caption=caption
      ),
      reply_markup=keyboard
  )
